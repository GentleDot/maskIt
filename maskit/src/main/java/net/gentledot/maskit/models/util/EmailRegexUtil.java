...
public class EmailRegexUtil {
    ...
    public static final String DOMAIN_NAME = "((?!-)[A-Za-z0-9-]+(?<!-)(\\.[A-Za-z0-9-]+(?<!-))*)"; // Domain name without leading/trailing dash
    public static final String DOT_BEFORE_TLD = "\\.";         // Dot before TLD
    public static final String TLD = "([A-Za-z]{2,13})";       // Top-level domain (TLD)
